...
function Dashboard() {
  ...
  //const isOnlineUser = (userId) => onlineUsers.some((u) => u.userId.toString() === userId.toString());
  ...
  const handelacceptCall = async () => {
    try {
      ...
      console.log("error in seding media device :", error)
    }
  }
